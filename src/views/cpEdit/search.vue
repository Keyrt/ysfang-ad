<template>
  <div class="app-container">
    ...
    <el-table-column width="180px" align="center" label="ID" >
      ...
      <el-table-column width="360px" align="center" label="作者">
        <template slot-scope="scope">
...
<script>
import { fetchSearchList } from "@/api/edit";
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import("@/vendor/Export2Excel").then(excel => {
        const tHeader = ["ID","时间", "书籍名称","作者", "总信息费", "结算收入"];
        const filterVal = ["id","time", "book_name","author_name", "income", "stratify"];
